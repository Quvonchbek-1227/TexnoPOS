			...
			<div class="container">
				<div class="schedule-page">
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item">
					    	<a class="nav-link active" id="grade1-tab" data-toggle="tab" href="#grade1" role="tab" aria-controls="grade1" aria-selected="true">1 - klass</a>
					  	</li>
					  	<li class="nav-item">
					    	<a class="nav-link" id="grade2-tab" data-toggle="tab" href="#grade2" role="tab" aria-controls="grade2" aria-selected="false">2 - klass</a>
					  	</li>
					  	<li class="nav-item">
					    	<a class="nav-link" id="grade3-tab" data-toggle="tab" href="#grade3" role="tab" aria-controls="grade3" aria-selected="false">3 - klass</a>
					  	</li>
					  	<li class="nav-item">
					    	<a class="nav-link" id="grade4-tab" data-toggle="tab" href="#grade4" role="tab" aria-controls="grade4" aria-selected="false">4 - klass</a>
					  	</li>
					</ul>
