                                        ...
                                        <div class="form theme-form">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Ati</label>
                                                        <input class="form-control" name="name" type="text" placeholder="Web dasturlew (Backend)">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Sag`atin Kiritin` (25 sabaq)</label>
                                                        <input class="form-control" name="hour" type="text" placeholder="25 sabaq">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="age" type="text" placeholder="15-30 jas">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Sabaq Waxti </label>
                                                        <input class="form-control" name="sub_time" type="text" placeholder="16:00 - 18:00">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="student_count" type="text " placeholder="30 adam ">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                                        ...
                                                        <input class="form-control " name="price" type="text " placeholder="290 min` sum ">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                                        <label>Sabaq Qaysi kunler boladi?</label><br>
                                                        <input class="form-control " name="days" type="text " placeholder="Taq kunleri ">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row ">
