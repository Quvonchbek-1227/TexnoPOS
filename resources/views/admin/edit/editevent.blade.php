                                        ...
                                        <div class="form theme-form">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Waqit</label>
                                                        <input class="form-control" value="{{$event[0]->date}}" name="date" type="date" placeholder="12.03.2021">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Summa</label>
                                                        <input class="form-control" value="{{$event[0]->price}}" name="price" type="text" placeholder="150 min`">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Adress</label>
                                                        <input class="form-control" value="{{$event[0]->adress}}" name="adress" type="text" placeholder="TexnoPOS Ofisinde">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Title</label>
                                                        <input class="form-control" value="{{$event[0]->title}}" name="title" type="text " placeholder="Title...">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                                        <label>Waqtin Kiritin`</label><br>
                                                        <input class="form-control" value="{{$event[0]->time}}" name="time" type="text " placeholder="14:00 - 16:00">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="col ">
                                                    <div class="mb-3 ">
                                                        ...
                                                        <textarea class="form-control " name="text" placeholder="Qosimsha mag`liwmat... " id=" " cols="30 " rows="10 ">
                                                        {{$event[0]->text}}
                                                        </textarea>
                                                    </div>
                                                </div>
