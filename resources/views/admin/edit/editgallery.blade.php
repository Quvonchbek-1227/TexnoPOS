...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3 style="text-transform: inherit">Galereyadan Suret O`zgertiw!</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <form enctype="multipart/form-data"  action="{{ route('admingallery.update',['admingallery'=>$id]) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
