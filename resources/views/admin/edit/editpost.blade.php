                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('adminposts.update', ['adminpost' => $post[0]->id])}}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row mb-5">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$post[0]->title}}" type="text" name="title" class="form-control" placeholder="title...">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="date">Sa`neni Kiritin`</label>
                                                    <input type="date" value="{{$post[0]->date}}" name="date" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
