                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('coming_covers.store') }}" method="POST">
                                        ...
                                        <div class="form theme-form">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="name" type="text" placeholder="Название чехола">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Штук</label>
                                                        <input class="form-control" name="piece" type="text" placeholder="Штук">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                    <label>Выберите модель</label><br>
                                                        <select class="form-control" name="model_id" id="">
                                                            ...
                                                            <option class="form-control" value="{{$model->id}}">{{$model->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
