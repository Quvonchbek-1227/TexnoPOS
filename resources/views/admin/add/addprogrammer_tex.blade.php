                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('adminprogrammertex.store') }}" method="POST">
                                        @csrf
                                        @method('POST')
                                        <div class="form theme-form">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label>Programmistdi Saylan`!</label>
                                                        <select required class="form-select" name="id_programmer" id="">

                                                            @foreach ($programmers as $programmer)
                                                                <option value="{{$programmer->id}}">{{$programmer->full_name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label>Texnalogiyani Saylan`!</label>
                                                        <select required class="form-select" name="id_texnalogiy" id="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="">Procent Kiritin`!</label>
                                                        <input name="procent" required class="form-control" type="number" placeholder="Procent...">
                                                    </div>
                                                </div>
