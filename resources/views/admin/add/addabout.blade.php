                                        ...
                                        <div class="form theme-form">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label>Title</label>
                                                        <input class="form-control" name="title" type="text" placeholder="Title Kiritin`">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label>Text</label>
                                                        <textarea class="form-control" placeholder="Text..." name="text" id="" cols="30" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
