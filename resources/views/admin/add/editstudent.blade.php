                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{route('adminstudents.update', ['adminstudent' => $students[0]->id])}}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" value="{{$students[0]->full_name}}" name="full_name" type="text" placeholder="Sharapat Kalabayev">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Telefon Nomeri</label>
                                                        <input class="form-control" value="{{$students[0]->phone}}" name="phone" type="text" placeholder="+998991234678">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Email</label>
                                                        <input class="form-control" value="{{$students[0]->email}}" name="email" type="text" placeholder="...@...mail.com">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                                        <label>Taj`ribesi</label><br>
                                                        <input class="form-control" value="{{$students[0]->experiense}}" name="experiense" type="text" placeholder="10 jil">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" value="{{$students[0]->bitirgen}}" name="bitirgen" type="text " placeholder="TATU No`kis Filiali...">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="mb-3 ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" value="{{$students[0]->telegram}}" name="telegram" type="text " placeholder="@ati...">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 ">
                                                    <div class="mb-3 ">
                                                        <label>Facebook Accounti<i class="fab fa-facebook fa-2x"></i></label><br>
                                                        <input class="form-control" value="{{$students[0]->facebook}}" name="facebook" type="text " placeholder="Facabookdag`i atin jazin`">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 ">
                                                    <div class="mb-3 ">
                                                        <label class="mb-1 form-label">Instagram Accounti<i class="fab fa-instagram fa-2x"></i></label><br>
                                                        <input class="form-control" value="{{$students[0]->instagram}}" name="instagram" type="text " placeholder="Instaname in jazin`">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 ">
                                                    <div class="mb-3 ">
                                                        <label class="mb-1 form-label">Tuwilg`an Kuni<i class="fas fa-birthday-cake fa-2x"></i></label><br>
                                                        <input class="form-control" value="{{$students[0]->birthday}}" name="birthday" type="text " placeholder="12.03.1998">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="col-md-6">
                                                    <div class="mb-3 ">
                                                        ...
                                                        <textarea class="form-control " name="about" placeholder="Qosimsha mag`liwmat... " id=" " cols="30 " rows="10 ">{{$students[0]->about}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3 ">
                                                        <label>Portfolio Ushin Qosimsha</label>
                                                        <textarea class="form-control" name="portfolio_detail" placeholder="Qosimsha mag`liwmat... " id=" " cols="30 " rows="10 ">{{$students[0]->portfolio_detail}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
