                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form enctype="multipart/form-data" action="{{ route('adminproects.store') }}" method="POST">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input required class="form-control" name="type" type="text " placeholder="proect tipi...">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 ">
                                                    <div class="mb-3 ">
                                                        <label>Proectge Title</label><br>
                                                        <input required class="form-control" name="title" type="text " placeholder="tile kiritin`">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3 ">
                                                        <label>Portfolio Ushin Qosimsha</label>
                                                        <textarea required class="form-control" name="portfolio_detail" placeholder="Qosimsha mag`liwmat..." id=" " cols="30 " rows="10 "></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="col-md-6">
                                                    <div class="text-end ">
                                                        <input required type="file" multiple name="suretler[]">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
