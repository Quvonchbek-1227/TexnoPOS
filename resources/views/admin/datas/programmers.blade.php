                    ...
                    <div class="table-responsive">
                      ...
                      <table class="display" id="basic-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td>{{$programmer->full_name}}</td>
                                                    <td>{{$programmer->phone}}</td>
                                                    <td>{{$programmer->email}}</td>
                                                    <td>{{$programmer->about}}</td>
                                                    <td>{{$programmer->portfolio_detail}}</td>
                                                    <td>{{$programmer->experiense}}</td>
                                                    <td>{{$programmer->bitirgen}}</td>
                                                    <td>{{$programmer->telegram}}</td>
                                                    <td>{{$programmer->facebook}}</td>
                                                    <td>{{$programmer->instagram}}</td>
                                                    <td>{{$programmer->img}}</td>
