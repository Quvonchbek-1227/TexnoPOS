                    ...
                    <div class="table-responsive">
                      ...
                      <table class="display" id="basic-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($texnologies as $texnology)
                                                    <tr>
                                                    <td>{{$texnology->name}}</td>
                                                   
                                                    
                                                   <td>
                                                   <form action="{{url('admintexnologies/'.$texnology->id)}}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
                                                  <button type="submit" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                                  </form> 
                                                    </td>
                                                    <td><a class="btn btn-danger btn-sm" href="{{route('admintexnologies.edit', ['admintexnology' => $texnology->id])}}"><i class="fa fa-pencil"></i></a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
