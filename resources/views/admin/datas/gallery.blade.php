            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-primary active" href="{{ route('admingallery.create') }}">Qosiw</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                  ...
                                  <div class="carousel-inner">
                                      <div class="carousel-item active">
                                          ...
                                          <div class="carousel-caption d-flex justify-content-between">
                                              <form class="form align-bottom" action="{{ route('admingallery.destroy', ['admingallery'=>$img->id]) }}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
                                              ...
                                              <p class="ml-2">
                                                  <a href="{{ route('admingallery.edit', ['admingallery'=>$img->id]) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                              </p>
                                          </div>
                                      </div>
                                  </div>
