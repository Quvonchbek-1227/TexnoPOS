            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <a class="btn btn-primary active" href="{{ route('adminprogrammertex.create') }}">Qosiw</a>
                    <h5></h5><span></span>
                  </div>
                  <div class="card-body">
                          ...
                          <tbody>
                            @foreach ($datas as $data)
                              <tr>
                                ...
                                <td>
                                  @foreach ($data['texnologiya'] as $tex)
                                  <hr>
                                      <div class="d-flex align-items-center">
                                        <b>{{$tex->name}} => {{$tex->procent}} %,</b>
                                        <form class="form" method="POST"  action="{{ route('adminprogrammertex.destroy', ['adminprogrammertex'=>$tex->id]) }}">
                                          @method('DELETE')
                                          @csrf
