            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <a class="btn btn-primary active" href="{{ route('adminmentortex.create') }}">Qosiw</a>
                    <h5></h5><span></span>
                  </div>
                  <div class="card-body">
                                ...
                                <td>
                                  ...
                                  <hr>
                                      <div class="d-flex align-items-center">
                                        ...
                                        <form class="form" method="POST"  action="{{ route('adminmentortex.destroy', ['adminmentortex'=>$tex->men_texid]) }}">
                                          @method('DELETE')
                                          @csrf
