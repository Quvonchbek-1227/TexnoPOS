...
--
-- Хост: localhost:3307
-- Время создания: Авг 07 2021 г., 11:15
...
(7, 'test', '33 333 33 33', 'test$gmail.com', 'aaaaaaaaaaa', 'bbbbbbbbbb', '100 jil', 'tatu', 1, '@test', 'test', 'test', 'file1', '12.09.2000');
...
CREATE TABLE `proects` (
  `id` int(11) NOT NULL,
  `is_mentor` int(2) DEFAULT '0',
  `is_programmer` int(2) DEFAULT '0',
  `type` varchar(255) NOT NULL,
  `text` text,
  `title` varchar(19) NOT NULL,
  `is_student` int(12) DEFAULT '0',
...
INSERT INTO `proects` (`id`, `is_mentor`, `is_programmer`, `type`, `text`, `title`, `is_student`, `id_person`, `updated_at`, `created_at`) VALUES
(50, 1, 0, 'for sale', 'dececercececece', 'wwww', 0, 3, '2021-08-07 08:12:35', '2021-08-07 08:12:35'),
(51, 0, 0, 'sdc', 'd w qqq qf qq', 'Mal satiladi', 0, 3, '2021-08-07 08:13:46', '2021-08-07 08:13:46');
...
INSERT INTO `proect_img` (`id`, `img`, `id_proect`, `created_at`, `updated_at`) VALUES
(141, 'http://127.0.0.1:8000/assets/img/proects/kotlinrus.jpg', 50, '2021-08-07 08:12:35', '2021-08-07 08:12:35'),
(142, 'http://127.0.0.1:8000/assets/img/proects/python.jpg', 50, '2021-08-07 08:12:35', '2021-08-07 08:12:35'),
(143, 'http://127.0.0.1:8000/assets/img/proects/web.jpg', 50, '2021-08-07 08:12:35', '2021-08-07 08:12:35'),
(144, 'http://127.0.0.1:8000/assets/img/proects/1.jpg', 51, '2021-08-07 08:13:46', '2021-08-07 08:13:46'),
(145, 'http://127.0.0.1:8000/assets/img/proects/2.jpg', 51, '2021-08-07 08:13:46', '2021-08-07 08:13:46'),
(146, 'http://127.0.0.1:8000/assets/img/proects/3.jpg', 51, '2021-08-07 08:13:46', '2021-08-07 08:13:46'),
(147, 'http://127.0.0.1:8000/assets/img/proects/4.jpg', 51, '2021-08-07 08:13:46', '2021-08-07 08:13:46');
